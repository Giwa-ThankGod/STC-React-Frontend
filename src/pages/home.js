...
const data = [
    {
        ...
        "description": "<p>I have created the templates folder and my hmtl file has been placed inside the folder already, but the template is still not displaying.</p>"
    },
    {
        "id": 2,
                ...
                <div className="row justify-contents-center align-items-center">
                    ...
                    <div className="col-md-6 mb-5">
                        <div className="card bg-transparent border-0">
                            <p className="display-6">SaruTech <span className="display-3">Community</span></p>
                            <p className="f-16">Efficiency | Management | Productivity</p>
                            <p className="text-muted">
                                STC is an online community for sarutech developers to mutally be assistance to one another
                                in answering questions, providing materials and documents e.t.c.
                            </p>
                            <a href="" className="btn btn-block btn-warning">Get Started</a>
                        </div>
                    </div>
